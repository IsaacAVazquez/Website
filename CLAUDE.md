...
5. **Experimental dashboards** — standalone tools like `/formula-1`, `/premier-league`, `/la-liga`, `/polling-aggregator`, `/news-pulse`, `/github-trending-pulse`, and `/spacex-mission-control`
