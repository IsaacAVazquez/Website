...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/EmptyPanel.tsx
  var EmptyPanel_exports = {};
  __export(EmptyPanel_exports, {
    GroupStage: () => GroupStage,
    QuietMatchweek: () => QuietMatchweek
  });
  init_define_import_meta_env();
  ...
  var GroupStage = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "max-w-xl", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.EmptyPanel,
    {
  ...
  var QuietMatchweek = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "max-w-md", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.EmptyPanel,
    {
  ...
  return __toCommonJS(EmptyPanel_exports);
})();
