...
304 CSS custom properties from isaac-vazquez-portfolio. Names are
preserved verbatim from upstream. They are declared inside `_ds_bundle.css` (this DS ships one compiled stylesheet rather than separate token files).

- **color** (76): `--color-red-300`, `--color-red-500`, `--color-red-700`, …
...
- **other** (170): `--spacing`, `--breakpoint-sm`, `--breakpoint-md`, …
