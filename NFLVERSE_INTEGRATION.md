> [!IMPORTANT]
> Historical reference only. This file captures an older NFLverse integration note and is not a current source of truth by itself. Use `AGENTS.md`, `CLAUDE.md`, `README.md`, `API.md`, `ARCHITECTURE.md`, and `docs/README.md` for current documentation.
