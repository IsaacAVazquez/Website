> [!IMPORTANT]
> Historical reference only. This redesign package documents an older contact-page plan and is not a current source of truth by itself. Use `AGENTS.md`, `CLAUDE.md`, `README.md`, `PAGES.md`, and `docs/README.md` for current documentation.
