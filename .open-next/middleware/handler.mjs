...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 232: (a) => {
      (() => {
        "use strict";
        var b = { 993: (a2) => {
      ...
      c.r(r), c.d(r, { config: () => bs, default: () => br });
      let t = null;
      async function u() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function F(a10) {
        let b2 = {}, c2 = [];
        if (a10) for (let [d2, e2] of a10.entries()) "set-cookie" === d2.toLowerCase() ? (c2.push(...E(e2)), b2[d2] = 1 === c2.length ? c2[0] : c2) : b2[d2] = e2;
        return b2;
      }
      function G(a10) {
        try {
      ...
      class K {
        constructor(a10, b2) {
          this[I] = false, this[J] = b2 ? { kind: "external", function: b2 } : { kind: "internal", promises: [] };
        }
        respondWith(a10) {
      ...
      function O(a10, b2) {
        ...
        let { pathname: c2, query: d2, hash: e2 } = N(a10);
        return `${b2}${c2}${d2}${e2}`;
      }
      function P(a10, b2) {
        if (!a10.startsWith("/") || !b2) return a10;
      ...
      function S(a10, b2) {
        ...
        let d2 = R.get(b2);
        d2 || (d2 = b2.map((a11) => a11.toLowerCase()), R.set(b2, d2));
        let e2 = a10.split("/", 2);
      ...
      function U(a10, b2) {
        return new URL(String(a10).replace(T, "localhost"), b2 && String(b2).replace(T, "localhost"));
      }
      let V = Symbol("NextURLInternal");
      class W {
        constructor(a10, b2, c2) {
          let d2, e2;
          "object" == typeof b2 && "pathname" in b2 || "string" == typeof b2 ? (d2 = b2, e2 = c2 || {}) : e2 = c2 || b2 || {}, this[V] = { url: U(a10, d2 ?? e2.base), options: e2, basePath: "" }, this.analyze();
        }
        analyze() {
          var a10, b2, c2, d2, e2;
          let f2 = function(a11, b3) {
            let { basePath: c3, i18n: d3, trailingSlash: e3 } = b3.nextConfig ?? {}, f3 = { pathname: a11, trailingSlash: "/" !== a11 ? a11.endsWith("/") : e3 };
            c3 && Q(f3.pathname, c3) && (f3.pathname = function(a12, b4) {
              if (!Q(a12, b4)) return a12;
            ...
            if (f3.pathname.startsWith("/_next/data/") && f3.pathname.endsWith(".json")) {
              ...
              f3.buildId = a12[0], g3 = "index" !== a12[1] ? `/${a12.slice(1).join("/")}` : "/", true === b3.parseData && (f3.pathname = g3);
            }
            if (d3) {
              let a12 = b3.i18nProvider ? b3.i18nProvider.analyze(f3.pathname) : S(f3.pathname, d3.locales);
              f3.locale = a12.detectedLocale, f3.pathname = a12.pathname ?? f3.pathname, !a12.detectedLocale && f3.buildId && (a12 = b3.i18nProvider ? b3.i18nProvider.analyze(g3) : S(g3, d3.locales)).detectedLocale && (f3.locale = a12.detectedLocale);
            }
            return f3;
          }(this[V].url.pathname, { nextConfig: this[V].options.nextConfig, parseData: true, i18nProvider: this[V].options.i18nProvider }), g2 = function(a11, b3) {
            let c3;
          ...
          this[V].domainLocale = this[V].options.i18nProvider ? this[V].options.i18nProvider.detectDomainLocale(g2) : function(a11, b3, c3) {
            if (a11) {
              for (let d3 of (c3 && (c3 = c3.toLowerCase()), a11)) if (b3 === d3.domain?.split(":", 1)[0].toLowerCase() || c3 === d3.defaultLocale.toLowerCase() || d3.locales?.some((a12) => a12.toLowerCase() === c3)) return d3;
            }
          }(null == (b2 = this[V].options.nextConfig) || null == (a10 = b2.i18n) ? void 0 : a10.domains, g2);
          let h2 = (null == (c2 = this[V].domainLocale) ? void 0 : c2.defaultLocale) || (null == (e2 = this[V].options.nextConfig) || null == (d2 = e2.i18n) ? void 0 : d2.defaultLocale);
        ...
        formatPathname() {
          ...
          return b2 = function(a11, b3, c2, d2) {
            ...
            return !d2 && (Q(e2, "/api") || Q(e2, `/${b3.toLowerCase()}`)) ? a11 : O(a11, `/${b3}`);
          }((a10 = { basePath: this[V].basePath, buildId: this[V].buildId, defaultLocale: this[V].options.forceLocale ? void 0 : this[V].defaultLocale, locale: this[V].locale, pathname: this[V].url.pathname, trailingSlash: this[V].trailingSlash }).pathname, a10.locale, a10.buildId ? void 0 : a10.defaultLocale, a10.ignorePrefix), (a10.buildId || !a10.trailingSlash) && (b2 = M(b2)), a10.buildId && (b2 = P(O(b2, `/_next/data/${a10.buildId}`), "/" === a10.pathname ? "index.json" : ".json")), b2 = O(b2, a10.basePath), !a10.buildId && a10.trailingSlash ? b2.endsWith("/") ? b2 : P(b2, "/") : M(b2);
        }
        formatSearch() {
        ...
        set locale(a10) {
          var b2, c2;
          if (!this[V].locale || !(null == (c2 = this[V].options.nextConfig) || null == (b2 = c2.i18n) ? void 0 : b2.locales.includes(a10))) throw Object.defineProperty(TypeError(`The NextURL configuration includes no locale "${a10}"`), "__NEXT_ERROR_CODE", { value: "E597", enumerable: false, configurable: true });
          this[V].locale = a10;
        }
        get defaultLocale() {
      ...
      class Z extends Request {
        constructor(a10, b2 = {}) {
          ...
          G(c2), a10 instanceof Request ? super(a10, b2) : super(c2, b2);
          const d2 = new W(c2, { headers: F(this.headers), nextConfig: b2.nextConfig });
          this[Y] = { cookies: new X.RequestCookies(this.headers), nextUrl: d2, url: d2.toString() };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      class ac extends Response {
        constructor(a10, b2 = {}) {
          super(a10, b2);
          const c2 = this.headers, d2 = new Proxy(new X.ResponseCookies(c2), { get(a11, d3, e2) {
            switch (d3) {
              case "delete":
              case "set":
                return (...e3) => {
                  let f2 = Reflect.apply(a11[d3], a11, e3), g2 = new Headers(c2);
                  return f2 instanceof X.ResponseCookies && c2.set("x-middleware-set-cookie", f2.getAll().map((a12) => (0, X.stringifyCookie)(a12)).join(",")), ab(b2, g2), f2;
                };
              default:
                return $.get(a11, d3, e2);
            }
          } });
          this[_] = { cookies: d2, url: b2.url ? new W(b2.url, { headers: F(c2), nextConfig: b2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static json(a10, b2) {
          ...
          return new ac(c2.body, c2);
        }
        static redirect(a10, b2) {
          let c2 = "number" == typeof b2 ? b2 : (null == b2 ? void 0 : b2.status) ?? 307;
          if (!aa.has(c2)) throw Object.defineProperty(RangeError('Failed to execute "redirect" on "response": Invalid status code'), "__NEXT_ERROR_CODE", { value: "E529", enumerable: false, configurable: true });
          let d2 = "object" == typeof b2 ? b2 : {}, e2 = new Headers(null == d2 ? void 0 : d2.headers);
          return e2.set("Location", G(a10)), new ac(null, { ...d2, headers: e2, status: c2 });
        }
        static rewrite(a10, b2) {
          let c2 = new Headers(null == b2 ? void 0 : b2.headers);
          return c2.set("x-middleware-rewrite", G(a10)), ab(b2, c2), new ac(null, { ...b2, headers: c2 });
        }
        static next(a10) {
          let b2 = new Headers(null == a10 ? void 0 : a10.headers);
          return b2.set("x-middleware-next", "1"), ab(a10, b2), new ac(null, { ...a10, headers: b2 });
        }
      }
      function ad(a10, b2) {
      ...
      class ai extends Headers {
        constructor(a10) {
          super(), this.headers = new Proxy(a10, { get(b2, c2, d2) {
            if ("symbol" == typeof c2) return $.get(b2, c2, d2);
            let e2 = c2.toLowerCase(), f2 = Object.keys(a10).find((a11) => a11.toLowerCase() === e2);
            if (void 0 !== f2) return $.get(b2, f2, d2);
          }, set(b2, c2, d2, e2) {
            if ("symbol" == typeof c2) return $.set(b2, c2, d2, e2);
            let f2 = c2.toLowerCase(), g2 = Object.keys(a10).find((a11) => a11.toLowerCase() === f2);
            return $.set(b2, g2 ?? c2, d2, e2);
          }, has(b2, c2) {
            if ("symbol" == typeof c2) return $.has(b2, c2);
            let d2 = c2.toLowerCase(), e2 = Object.keys(a10).find((a11) => a11.toLowerCase() === d2);
            return void 0 !== e2 && $.has(b2, e2);
          }, deleteProperty(b2, c2) {
            if ("symbol" == typeof c2) return $.deleteProperty(b2, c2);
            let d2 = c2.toLowerCase(), e2 = Object.keys(a10).find((a11) => a11.toLowerCase() === d2);
            return void 0 === e2 || $.deleteProperty(b2, e2);
          } });
        }
        static seal(a10) {
      ...
      let al = "u" > typeof globalThis && globalThis.AsyncLocalStorage;
      function am() {
      ...
      class ar {
        static wrap(a10, b2) {
          let c2 = new X.ResponseCookies(new Headers());
          for (let b3 of a10.getAll()) c2.set(b3);
          let d2 = [], e2 = /* @__PURE__ */ new Set(), f2 = () => {
            let a11 = an.getStore();
            if (a11 && (a11.pathWasRevalidated = 1), d2 = c2.getAll().filter((a12) => e2.has(a12.name)), b2) {
              let a12 = [];
              for (let b3 of d2) {
                let c3 = new X.ResponseCookies(new Headers());
      ...
      var at = ((f = at || {}).handleRequest = "BaseServer.handleRequest", f.run = "BaseServer.run", f.pipe = "BaseServer.pipe", f.getStaticHTML = "BaseServer.getStaticHTML", f.render = "BaseServer.render", f.renderToResponseWithComponents = "BaseServer.renderToResponseWithComponents", f.renderToResponse = "BaseServer.renderToResponse", f.renderToHTML = "BaseServer.renderToHTML", f.renderError = "BaseServer.renderError", f.renderErrorToResponse = "BaseServer.renderErrorToResponse", f.renderErrorToHTML = "BaseServer.renderErrorToHTML", f.render404 = "BaseServer.render404", f), au = ((g = au || {}).loadDefaultErrorComponents = "LoadComponents.loadDefaultErrorComponents", g.loadComponents = "LoadComponents.loadComponents", g), av = ((h = av || {}).getRequestHandler = "NextServer.getRequestHandler", h.getRequestHandlerWithMetadata = "NextServer.getRequestHandlerWithMetadata", h.getServer = "NextServer.getServer", h.getServerRequestHandler = "NextServer.getServerRequestHandler", h.createServer = "createServer.createServer", h), aw = ((i = aw || {}).compression = "NextNodeServer.compression", i.getBuildId = "NextNodeServer.getBuildId", i.createComponentTree = "NextNodeServer.createComponentTree", i.clientComponentLoading = "NextNodeServer.clientComponentLoading", i.getLayoutOrPageModule = "NextNodeServer.getLayoutOrPageModule", i.generateStaticRoutes = "NextNodeServer.generateStaticRoutes", i.generateFsStaticRoutes = "NextNodeServer.generateFsStaticRoutes", i.generatePublicRoutes = "NextNodeServer.generatePublicRoutes", i.generateImageRoutes = "NextNodeServer.generateImageRoutes.route", i.sendRenderResult = "NextNodeServer.sendRenderResult", i.proxyRequest = "NextNodeServer.proxyRequest", i.runApi = "NextNodeServer.runApi", i.render = "NextNodeServer.render", i.renderHTML = "NextNodeServer.renderHTML", i.imageOptimizer = "NextNodeServer.imageOptimizer", i.getPagePath = "NextNodeServer.getPagePath", i.getRoutesManifest = "NextNodeServer.getRoutesManifest", i.findPageComponents = "NextNodeServer.findPageComponents", i.getFontManifest = "NextNodeServer.getFontManifest", i.getServerComponentManifest = "NextNodeServer.getServerComponentManifest", i.getRequestHandler = "NextNodeServer.getRequestHandler", i.renderToHTML = "NextNodeServer.renderToHTML", i.renderError = "NextNodeServer.renderError", i.renderErrorToHTML = "NextNodeServer.renderErrorToHTML", i.render404 = "NextNodeServer.render404", i.startResponse = "NextNodeServer.startResponse", i.route = "route", i.onProxyReq = "onProxyReq", i.apiResolver = "apiResolver", i.internalFetch = "internalFetch", i), ax = ((j = ax || {}).startServer = "startServer.startServer", j), ay = ((k = ay || {}).getServerSideProps = "Render.getServerSideProps", k.getStaticProps = "Render.getStaticProps", k.renderToString = "Render.renderToString", k.renderDocument = "Render.renderDocument", k.createBodyResult = "Render.createBodyResult", k), az = ((l = az || {}).renderToString = "AppRender.renderToString", l.renderToReadableStream = "AppRender.renderToReadableStream", l.getBodyResult = "AppRender.getBodyResult", l.fetch = "AppRender.fetch", l), aA = ((m = aA || {}).executeRoute = "Router.executeRoute", m), aB = ((n = aB || {}).runHandler = "Node.runHandler", n), aC = ((o = aC || {}).runHandler = "AppRouteRouteHandlers.runHandler", o), aD = ((p = aD || {}).generateMetadata = "ResolveMetadata.generateMetadata", p.generateViewport = "ResolveMetadata.generateViewport", p), aE = ((q = aE || {}).execute = "Middleware.execute", q);
      ...
      let aI = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: aJ, propagation: aK, trace: aL, SpanStatusCode: aM, SpanKind: aN, ROOT_CONTEXT: aO } = d = c(446);
      ...
      let aQ = (a10, b2) => {
        "object" == typeof b2 && null !== b2 && b2 instanceof aP && b2.bubble ? a10.setAttribute("next.bubble", true) : (b2 && (a10.recordException(b2), a10.setAttribute("error.type", b2.name)), a10.setStatus({ code: aM.ERROR, message: null == b2 ? void 0 : b2.message })), a10.end();
      }, aR = /* @__PURE__ */ new Map(), aS = d.createContextKey("next.rootSpanId"), aT = 0, aU = { set(a10, b2, c2) {
      ...
      class aV {
        ...
        getTracePropagationData() {
          let a10 = aJ.active(), b2 = [];
          return aK.inject(a10, b2, aU), b2;
        }
        getActiveScopeSpan() {
        ...
        withPropagatedContext(a10, b2, c2) {
          let d2 = aJ.active();
          if (aL.getSpanContext(d2)) return b2();
          let e2 = aK.extract(d2, a10, c2);
          return aJ.with(e2, b2);
        }
        trace(...a10) {
          let [b2, c2, d2] = a10, { fn: e2, options: f2 } = "function" == typeof c2 ? { fn: c2, options: {} } : { fn: d2, options: { ...c2 } }, g2 = f2.spanName ?? b2;
          if (!aF.has(b2) && "1" !== process.env.NEXT_OTEL_VERBOSE || f2.hideSpan) return e2();
          let h2 = this.getSpanContext((null == f2 ? void 0 : f2.parentSpan) ?? this.getActiveScopeSpan());
          h2 || (h2 = (null == aJ ? void 0 : aJ.active()) ?? aO);
          let i2 = h2.getValue(aS), j2 = "number" != typeof i2 || !aR.has(i2), k2 = aT++;
          return f2.attributes = { "next.span_name": g2, "next.span_type": b2, ...f2.attributes }, aJ.with(h2.setValue(aS, k2), () => this.getTracerInstance().startActiveSpan(g2, f2, (a11) => {
            let c3;
            aI && b2 && aG.has(b2) && (c3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0);
            let d3 = false, g3 = () => {
              !d3 && (d3 = true, aR.delete(k2), c3 && performance.measure(`${aI}:next-${(b2.split(".").pop() || "").replace(/[A-Z]/g, (a12) => "-" + a12.toLowerCase())}`, { start: c3, end: performance.now() }));
            };
            if (j2 && aR.set(k2, new Map(Object.entries(f2.attributes ?? {}))), e2.length > 1) try {
              return e2(a11, (b3) => aQ(a11, b3));
            } catch (b3) {
              throw aQ(a11, b3), b3;
            } finally {
              g3();
            ...
            try {
              let b3 = e2(a11);
              if (aH(b3)) return b3.then((b4) => (a11.end(), b4)).catch((b4) => {
                throw aQ(a11, b4), b4;
              }).finally(g3);
              return a11.end(), g3(), b3;
            } catch (b3) {
              throw aQ(a11, b3), g3(), b3;
            }
          }));
        }
        wrap(...a10) {
          let b2 = this, [c2, d2, e2] = 3 === a10.length ? a10 : [a10[0], {}, a10[1]];
          return aF.has(c2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            let a11 = d2;
            ...
            {
              let d3 = b2.getContext().bind(aJ.active(), g2);
        ...
        setRootSpanAttribute(a10, b2) {
          let c2 = aJ.active().getValue(aS), d2 = aR.get(c2);
          d2 && !d2.has(a10) && d2.set(a10, b2);
        }
        withSpan(a10, b2) {
          let c2 = aL.setSpan(aJ.active(), a10);
          return aJ.with(c2, b2);
        }
      }
      let aW = (e = new aV(), () => e), aX = "__prerender_bypass";
      Symbol("__next_preview_data"), Symbol(aX);
      class aY {
        constructor(a10, b2, c2, d2) {
          var e2;
          const f2 = a10 && function(a11, b3) {
            let c3 = ai.from(a11.headers);
          ...
          }(b2, a10).isOnDemandRevalidate, g2 = null == (e2 = c2.get(aX)) ? void 0 : e2.value;
      ...
      function aZ(a10, b2) {
        if ("x-middleware-set-cookie" in a10.headers && "string" == typeof a10.headers["x-middleware-set-cookie"]) {
          ...
          for (let a11 of E(c2)) d2.append("set-cookie", a11);
          for (let a11 of new X.ResponseCookies(d2).getAll()) b2.set(a11);
        }
      }
      let a$ = am();
      var a_ = c(232), a0 = c.n(a_);
      ...
      let a2 = Symbol.for("@next/cache-handlers-map"), a3 = Symbol.for("@next/cache-handlers-set"), a4 = globalThis;
      function a5() {
        if (a4[a2]) return a4[a2].entries();
      }
      async function a6(a10, b2) {
        if (!a10) return b2();
        let c2 = a7(a10);
        try {
          return await b2();
          ...
          var d2, e2;
          let b3, f2, g2 = (d2 = c2, e2 = a7(a10), b3 = new Set(d2.pendingRevalidatedTags.map((a11) => {
            let b4 = "object" == typeof a11.profile ? JSON.stringify(a11.profile) : a11.profile || "";
            return `${a11.tag}:${b4}`;
      ...
      async function a8(a10, b2, c2) {
        ...
        let d2 = function() {
          if (a4[a3]) return a4[a3].values();
        }(), e2 = [], f2 = /* @__PURE__ */ new Map();
        for (let b3 of a10) {
          let a11, c3 = b3.profile;
        ...
        for (let [a11, h2] of f2) {
          ...
          if (a11) {
            let b3;
            if ("object" == typeof a11) b3 = a11;
            else if ("string" == typeof a11) {
              var g2;
              if (!(b3 = null == c2 || null == (g2 = c2.cacheLifeProfiles) ? void 0 : g2[a11])) throw Object.defineProperty(Error(`Invalid profile provided "${a11}" must be configured under cacheLife in next.config or be "max"`), "__NEXT_ERROR_CODE", { value: "E873", enumerable: false, configurable: true });
            }
            b3 && (f3 = { expire: b3.expire });
          }
          for (let b3 of d2 || []) a11 ? e2.push(null == b3.updateTags ? void 0 : b3.updateTags.call(b3, h2, f3)) : e2.push(null == b3.updateTags ? void 0 : b3.updateTags.call(b3, h2));
          b2 && e2.push(b2.revalidateTag(h2, f3));
        }
        await Promise.all(e2);
      }
      async function a9(a10, b2) {
        ...
        return Promise.all([a8(c2, a10.incrementalCache, a10), ...Object.values(d2), ...e2]);
      }
      let ba = Object.defineProperty(Error("Invariant: AsyncLocalStorage accessed in runtime where it is not available"), "__NEXT_ERROR_CODE", { value: "E504", enumerable: false, configurable: true });
      class bb {
        disable() {
          throw ba;
        }
      ...
      let bc = "u" > typeof globalThis && globalThis.AsyncLocalStorage, bd = bc ? new bc() : new bb();
      class be {
        constructor({ waitUntil: a10, onClose: b2, onTaskError: c2 }) {
          this.workUnitStores = /* @__PURE__ */ new Set(), this.waitUntil = a10, this.onClose = b2, this.onTaskError = c2, this.callbackQueue = new (a0())(), this.callbackQueue.pause();
        }
        after(a10) {
          if (aH(a10)) this.waitUntil || bf(), this.waitUntil(a10.catch((a11) => this.reportTaskError("promise", a11)));
        ...
        addCallback(a10) {
          ...
          let d2 = bd.getStore(), e2 = d2 ? d2.rootTaskSpawnPhase : null == c2 ? void 0 : c2.phase;
          this.runCallbacksOnClosePromise || (this.runCallbacksOnClosePromise = this.runCallbacksOnClose(), this.waitUntil(this.runCallbacksOnClosePromise));
          let f2 = (b2 = async () => {
            try {
              await bd.run({ rootTaskSpawnPhase: e2 }, () => a10());
            } catch (a11) {
              this.reportTaskError("function", a11);
            }
          }, bc ? bc.bind(b2) : bb.bind(b2));
        ...
        async runCallbacks() {
          ...
          return a6(a10, () => (this.callbackQueue.start(), this.callbackQueue.onIdle()));
        }
      ...
      function bg(a10) {
        let b2, c2 = { then: (d2, e2) => (b2 || (b2 = Promise.resolve(a10())), b2.then((a11) => {
          c2.value = a11;
        }).catch(() => {
        }), b2.then(d2, e2)) };
        return c2;
      ...
      let bj = Symbol.for("@next/request-context");
      async function bk(a10, b2, c2) {
        ...
        for (let b3 of ((a11) => {
          ...
          return b4;
        })(a10)) b3 = `${C}${b3}`, d2.add(b3);
        if (b2.pathname && (!c2 || 0 === c2.size)) {
          let a11 = `${C}${b2.pathname}`;
          d2.add(a11);
        }
        d2.has(`${C}/`) && d2.add(`${C}/index`), d2.has(`${C}/index`) && d2.add(`${C}/`);
        let e2 = Array.from(d2);
        return { tags: e2, expirationsByCacheKind: function(a11) {
          let b3 = /* @__PURE__ */ new Map(), c3 = a5();
          if (c3) for (let [d3, e3] of c3) "getExpiration" in e3 && b3.set(d3, bg(async () => e3.getExpiration(a11)));
          return b3;
        }(e2) };
      }
      class bl extends Z {
      ...
      let bm = { keys: (a10) => Array.from(a10.keys()), get: (a10, b2) => a10.get(b2) ?? void 0 }, bn = (a10, b2) => aW().withPropagatedContext(a10.headers, b2, bm), bo = false;
      async function bp(a10) {
        var b2, d2, e2, f2;
        let g2, h2, i2, j2, k2;
        !function() {
          if (!bo && (bo = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
            let { interceptTestApis: a11, wrapRequestHandler: b3 } = c(987);
            a11(), bn = b3(bn);
          }
        }(), await x();
        let l2 = void 0 !== globalThis.__BUILD_MANIFEST;
        a10.request.url = a10.request.url.replace(/\.rsc($|\?)/, "$1");
        let m2 = a10.bypassNextUrl ? new URL(a10.request.url) : new W(a10.request.url, { headers: a10.request.headers, nextConfig: a10.request.nextConfig });
        for (let a11 of [...m2.searchParams.keys()]) {
          let b3 = m2.searchParams.getAll(a11), c2 = function(a12) {
            for (let b4 of ["nxtP", "nxtI"]) if (a12 !== b4 && a12.startsWith(b4)) return a12.substring(b4.length);
            return null;
          }(a11);
          if (c2) {
            for (let a12 of (m2.searchParams.delete(c2), b3)) m2.searchParams.append(c2, a12);
        ...
        if (!l2) for (let a11 of af) {
          let b3 = o2.get(a11);
          null !== b3 && (r2.set(a11, b3), o2.delete(a11));
        }
        let s2 = m2.searchParams.get(ag), t2 = new bl({ page: a10.page, input: ((j2 = (i2 = "string" == typeof m2) ? new URL(m2) : m2).searchParams.delete(ag), i2 ? j2.toString() : j2).toString(), init: { body: a10.request.body, headers: o2, method: a10.request.method, nextConfig: a10.request.nextConfig, signal: a10.request.signal } });
        p2 && Object.defineProperty(t2, "__isData", { enumerable: false, value: true }), !globalThis.__incrementalCacheShared && a10.IncrementalCache && (globalThis.__incrementalCache = new a10.IncrementalCache({ CurCacheHandler: a10.incrementalCacheHandler, minimalMode: true, fetchCacheKeyPrefix: "", dev: false, requestHeaders: a10.request.headers, getPrerenderManifest: () => ({ version: -1, routes: {}, dynamicRoutes: {}, notFoundRoutes: [], preview: bi() }) }));
        let u2 = a10.request.waitUntil ?? (null == (b2 = null == (k2 = globalThis[bj]) ? void 0 : k2.get()) ? void 0 : b2.waitUntil), v2 = new L({ request: t2, page: a10.page, context: u2 ? { waitUntil: u2 } : void 0 });
        if ((g2 = await bn(t2, () => {
          if ("/middleware" === a10.page || "/src/middleware" === a10.page || "/proxy" === a10.page || "/src/proxy" === a10.page) {
            let b3 = v2.waitUntil.bind(v2), c2 = new bh();
            return aW().trace(aE.execute, { spanName: `middleware ${t2.method}`, attributes: { "http.target": t2.nextUrl.pathname, "http.method": t2.method } }, async () => {
              try {
                var d3, e3, f3, g3, i3, j3;
                let k3 = bi(), l3 = await bk("/", t2.nextUrl, null), m3 = (i3 = t2.nextUrl, j3 = (a11) => {
                  h2 = a11;
                }, function(a11, b4, c3, d4, e4, f4, g4, h3, i4, j4, k4, l4) {
                  function m4(a12) {
                  ...
                  return { type: "request", phase: a11, implicitTags: f4, url: { pathname: d4.pathname, search: d4.search ?? "" }, rootParams: e4, get headers() {
                    return n3.headers || (n3.headers = function(a12) {
                      let b5 = ai.from(a12);
                      for (let a13 of af) b5.delete(a13);
                      return ai.seal(b5);
                    }(b4.headers)), n3.headers;
                  }, get cookies() {
                    if (!n3.cookies) {
                      let a12 = new X.RequestCookies(ai.from(b4.headers));
                      aZ(b4, a12), n3.cookies = ap.seal(a12);
                    }
                    return n3.cookies;
                  }, set cookies(value) {
                    n3.cookies = value;
                    ...
                    if (!n3.mutableCookies) {
                      var o4, p3;
                      let a12, d5 = (o4 = b4.headers, p3 = g4 || (c3 ? m4 : void 0), a12 = new X.RequestCookies(ai.from(o4)), ar.wrap(a12, p3));
                      aZ(b4, d5), n3.mutableCookies = d5;
                    }
                    ...
                    if (!n3.userspaceMutableCookies) {
                      var q3;
                      let a12;
                      q3 = this, n3.userspaceMutableCookies = a12 = new Proxy(q3.mutableCookies, { get(b5, c4, d5) {
                        switch (c4) {
                          case "delete":
                            return function(...c5) {
                              return as(q3, "cookies().delete"), b5.delete(...c5), a12;
                            };
                          case "set":
                            return function(...c5) {
                              return as(q3, "cookies().set"), b5.set(...c5), a12;
                            };
                          default:
                            return $.get(b5, c4, d5);
                        }
                    ...
                    return n3.draftMode || (n3.draftMode = new aY(i4, b4, this.cookies, this.mutableCookies)), n3.draftMode;
                ...
                }("action", t2, void 0, i3, {}, l3, j3, null, k3, false, void 0, null)), o3 = function({ page: a11, renderOpts: b4, isPrefetchRequest: c3, buildId: d4, previouslyRevalidatedTags: e4, nonce: f4 }) {
                  var g4;
                  let h3 = !b4.shouldWaitOnAllReady && !b4.supportsDynamicResponse && !b4.isDraftMode && !b4.isPossibleServerAction, i4 = b4.dev ?? false, j4 = i4 || h3 && (!!process.env.NEXT_DEBUG_BUILD || "1" === process.env.NEXT_SSG_FETCH_METRICS), k4 = { isStaticGeneration: h3, page: a11, route: (g4 = a11.split("/").reduce((a12, b5, c4, d5) => b5 ? "(" === b5[0] && b5.endsWith(")") || "@" === b5[0] || ("page" === b5 || "route" === b5) && c4 === d5.length - 1 ? a12 : `${a12}/${b5}` : a12, "")).startsWith("/") ? g4 : `/${g4}`, incrementalCache: b4.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: b4.cacheLifeProfiles, isBuildTimePrerendering: b4.nextExport, hasReadableErrorStacks: b4.hasReadableErrorStacks, fetchCache: b4.fetchCache, isOnDemandRevalidate: b4.isOnDemandRevalidate, isDraftMode: b4.isDraftMode, isPrefetchRequest: c3, buildId: d4, reactLoadableManifest: (null == b4 ? void 0 : b4.reactLoadableManifest) || {}, assetPrefix: (null == b4 ? void 0 : b4.assetPrefix) || "", nonce: f4, afterContext: function(a12) {
                    let { waitUntil: b5, onClose: c4, onAfterTaskError: d5 } = a12;
                    return new be({ waitUntil: b5, onClose: c4, onTaskError: d5 });
                  }(b4), cacheComponentsEnabled: b4.cacheComponents, dev: i4, previouslyRevalidatedTags: e4, refreshTagsByCacheKind: function() {
                    let a12 = /* @__PURE__ */ new Map(), b5 = a5();
                    if (b5) for (let [c4, d5] of b5) "refreshTags" in d5 && a12.set(c4, bg(async () => d5.refreshTags()));
                    return a12;
                  }(), runInCleanSnapshot: bc ? bc.snapshot() : function(a12, ...b5) {
                    return a12(...b5);
                  }, shouldTrackFetchMetrics: j4, reactServerErrorsByDigest: /* @__PURE__ */ new Map() };
                  return b4.store = k4, k4;
                }({ page: "/", renderOpts: { cacheLifeProfiles: null == (e3 = a10.request.nextConfig) || null == (d3 = e3.experimental) ? void 0 : d3.cacheLife, cacheComponents: false, experimental: { isRoutePPREnabled: false, authInterrupts: !!(null == (g3 = a10.request.nextConfig) || null == (f3 = g3.experimental) ? void 0 : f3.authInterrupts) }, supportsDynamicResponse: true, waitUntil: b3, onClose: c2.onClose.bind(c2), onAfterTaskError: void 0 }, isPrefetchRequest: "1" === t2.headers.get(ae), buildId: n2 ?? "", previouslyRevalidatedTags: [] });
                return await an.run(o3, () => a$.run(m3, a10.handler, t2, v2));
              } finally {
                setTimeout(() => {
                  c2.dispatchClose();
                }, 0);
        ...
        if (g2 && w2 && (q2 || !l2)) {
          let b3 = new W(w2, { forceLocale: true, headers: a10.request.headers, nextConfig: a10.request.nextConfig });
          l2 || b3.host !== t2.nextUrl.host || (b3.buildId = n2 || b3.buildId, g2.headers.set("x-middleware-rewrite", String(b3)));
          let { url: c2, isRelative: h3 } = ad(b3.toString(), m2.toString());
          !l2 && p2 && g2.headers.set("x-nextjs-rewrite", c2);
          let i3 = !h3 && (null == (f2 = a10.request.nextConfig) || null == (e2 = f2.experimental) || null == (d2 = e2.clientParamParsingOrigins) ? void 0 : d2.some((a11) => new RegExp(a11).test(b3.origin)));
          q2 && (h3 || i3) && (m2.pathname !== b3.pathname && g2.headers.set("x-nextjs-rewritten-path", b3.pathname), m2.search !== b3.search && g2.headers.set("x-nextjs-rewritten-query", b3.search.slice(1)));
        }
        if (g2 && w2 && q2 && s2) {
          let a11 = new URL(w2);
          a11.searchParams.has(ag) || (a11.searchParams.set(ag, s2), g2.headers.set("x-middleware-rewrite", a11.toString()));
        }
        let y2 = null == g2 ? void 0 : g2.headers.get("Location");
        if (g2 && y2 && !l2) {
          let b3 = new W(y2, { forceLocale: false, headers: a10.request.headers, nextConfig: a10.request.nextConfig });
          g2 = new Response(g2.body, g2), b3.host === m2.host && (b3.buildId = n2 || b3.buildId, g2.headers.set("Location", ad(b3, m2).url)), p2 && (g2.headers.delete("Location"), g2.headers.set("x-nextjs-redirect", ad(b3.toString(), m2.toString()).url));
        }
        let z2 = g2 || ac.next(), A2 = z2.headers.get("x-middleware-override-headers"), B2 = [];
        if (A2) {
          for (let [a11, b3] of r2) z2.headers.set(`x-middleware-request-${a11}`, b3), B2.push(a11);
          B2.length > 0 && z2.headers.set("x-middleware-override-headers", A2 + "," + B2.join(","));
        }
        return { response: z2, waitUntil: ("internal" === v2[J].kind ? Promise.all(v2[J].promises).then(() => {
        }) : void 0) ?? Promise.resolve(), fetchMetrics: t2.fetchMetrics };
      }
      c(990), "u" < typeof URLPattern || URLPattern;
      var bq = c(345);
      if (/* @__PURE__ */ new WeakMap(), bq.unstable_postpone, false === ("Route %%% needs to bail out of prerendering at this point because it used ^^^. React throws this special object to indicate where. It should not be caught by your own try/catch. Learn more: https://nextjs.org/docs/messages/ppr-caught-error".includes("needs to bail out of prerendering at this point because it used") && "Route %%% needs to bail out of prerendering at this point because it used ^^^. React throws this special object to indicate where. It should not be caught by your own try/catch. Learn more: https://nextjs.org/docs/messages/ppr-caught-error".includes("Learn more: https://nextjs.org/docs/messages/ppr-caught-error"))) throw Object.defineProperty(Error("Invariant: isDynamicPostpone misidentified a postpone reason. This is a bug in Next.js"), "__NEXT_ERROR_CODE", { value: "E296", enumerable: false, configurable: true });
      function br(a10) {
        let b2 = ac.next();
        return Object.entries({ "Content-Security-Policy": "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: blob:; font-src 'self'; connect-src 'self' https://api.fantasypros.com https://cloudflareinsights.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'", "X-Frame-Options": "DENY", "X-Content-Type-Options": "nosniff", "X-XSS-Protection": "1; mode=block", "Referrer-Policy": "strict-origin-when-cross-origin", "Permissions-Policy": "camera=(), microphone=(), geolocation=()", "Strict-Transport-Security": "max-age=31536000; includeSubDomains" }).forEach(([a11, c2]) => {
          b2.headers.set(a11, c2);
        }), b2.headers.set("Netlify-CDN-Cache-Control", "no-store"), b2;
      }
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`);
      let bs = { matcher: ["/((?!_next/static|_next/image|favicon.ico|api/).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bt = { ...r }, bu = "/src/middleware", bv = (0, bt.middleware || bt.default);
      class bw extends Error {
        constructor(a10) {
          super(a10), this.stack = "";
        }
      }
      if ("function" != typeof bv) throw new bw(`The Middleware file "${bu}" must export a function named \`middleware\` or a default function.`);
      let bx = (a10) => bp({ ...a10, page: bu, handler: async (...a11) => {
        try {
          return await bv(...a11);
        } catch (e2) {
          let b2 = a11[0], c2 = new URL(b2.url), d2 = c2.pathname + c2.search;
          throw await v(e2, { path: d2, method: b2.method, headers: Object.fromEntries(b2.headers.entries()) }, { routerKind: "Pages Router", routePath: "/proxy", routeType: "proxy", revalidateReason: void 0 }), e2;
        }
      } });
    }, 643: (a, b, c) => {
      "use strict";
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|api\\/).*))(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "typescript": { "ignoreBuildErrors": true }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.mjs", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 2592e3, "formats": ["image/avif", "image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": true, "contentSecurityPolicy": "default-src 'self'; script-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [{ "protocol": "https", "hostname": "images.unsplash.com" }, { "protocol": "https", "hostname": "res.cloudinary.com" }], "qualities": [75], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": { "removeConsole": true }, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Users/isaacvazquez/Website", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 11, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": true, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": false, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": false, "lockDistDir": true, "isolatedDevBuild": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": false, "optimizePackageImports": ["@tabler/icons-react", "lucide-react", "framer-motion", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.mjs", "serverExternalPackages": ["better-sqlite3", "sharp"], "outputFileTracingExcludes": { "*": ["**/node_modules/@img/**", "**/node_modules/sharp/**", "**/public/data/investments/**"] }, "turbopack": { "root": "/Users/isaacvazquez/Website" }, "distDirRoot": ".next", "_originalRedirects": [{ "source": "/projects", "destination": "/portfolio", "permanent": true }, { "source": "/work", "destination": "/portfolio", "permanent": true }, { "source": "/projects/:path*", "destination": "/portfolio/:path*", "permanent": true }, { "source": "/portfolio/investment-analytics-platform", "destination": "/investments", "permanent": true }, { "source": "/ff", "destination": "/fantasy-football", "permanent": false }, { "source": "/rankings", "destination": "/fantasy-football", "permanent": false }, { "source": "/qb", "destination": "/fantasy-football?position=qb&scoring=ppr", "permanent": false }, { "source": "/rb", "destination": "/fantasy-football?position=rb&scoring=ppr", "permanent": false }, { "source": "/wr", "destination": "/fantasy-football?position=wr&scoring=ppr", "permanent": false }, { "source": "/te", "destination": "/fantasy-football?position=te&scoring=ppr", "permanent": false }, { "source": "/fantsy-football/:path*", "destination": "/fantasy-football/:path*", "permanent": false }, { "source": "/fantasy-footbal/:path*", "destination": "/fantasy-football/:path*", "permanent": false }, { "source": "/quatrerback", "destination": "/fantasy-football?position=qb&scoring=ppr", "permanent": false }, { "source": "/blog", "destination": "/writing", "permanent": true }, { "source": "/blog/:slug", "destination": "/writing/:slug", "permanent": true }, { "source": "/blog/posts/:slug", "destination": "/writing/:slug", "permanent": true }, { "source": "/articles/:slug", "destination": "/writing/:slug", "permanent": true }, { "source": "/get-in-touch", "destination": "/contact", "permanent": true }, { "source": "/hire-me", "destination": "/contact", "permanent": true }, { "source": "/cv", "destination": "/resume", "permanent": true }, { "source": "/resume.pdf", "destination": "/Isaac_Vazquez_Resume.pdf", "permanent": true }] };
var BuildId = "ooiPNaC4xMZGBCIMNF3cX";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }, { "source": "/projects", "destination": "/portfolio", "statusCode": 308, "regex": "^(?!/_next)/projects(?:/)?$" }, { "source": "/work", "destination": "/portfolio", "statusCode": 308, "regex": "^(?!/_next)/work(?:/)?$" }, { "source": "/projects/:path*", "destination": "/portfolio/:path*", "statusCode": 308, "regex": "^(?!/_next)/projects(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/portfolio/investment-analytics-platform", "destination": "/investments", "statusCode": 308, "regex": "^(?!/_next)/portfolio/investment-analytics-platform(?:/)?$" }, { "source": "/ff", "destination": "/fantasy-football", "statusCode": 307, "regex": "^(?!/_next)/ff(?:/)?$" }, { "source": "/rankings", "destination": "/fantasy-football", "statusCode": 307, "regex": "^(?!/_next)/rankings(?:/)?$" }, { "source": "/qb", "destination": "/fantasy-football?position=qb&scoring=ppr", "statusCode": 307, "regex": "^(?!/_next)/qb(?:/)?$" }, { "source": "/rb", "destination": "/fantasy-football?position=rb&scoring=ppr", "statusCode": 307, "regex": "^(?!/_next)/rb(?:/)?$" }, { "source": "/wr", "destination": "/fantasy-football?position=wr&scoring=ppr", "statusCode": 307, "regex": "^(?!/_next)/wr(?:/)?$" }, { "source": "/te", "destination": "/fantasy-football?position=te&scoring=ppr", "statusCode": 307, "regex": "^(?!/_next)/te(?:/)?$" }, { "source": "/fantsy-football/:path*", "destination": "/fantasy-football/:path*", "statusCode": 307, "regex": "^(?!/_next)/fantsy-football(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/fantasy-footbal/:path*", "destination": "/fantasy-football/:path*", "statusCode": 307, "regex": "^(?!/_next)/fantasy-footbal(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/quatrerback", "destination": "/fantasy-football?position=qb&scoring=ppr", "statusCode": 307, "regex": "^(?!/_next)/quatrerback(?:/)?$" }, { "source": "/blog", "destination": "/writing", "statusCode": 308, "regex": "^(?!/_next)/blog(?:/)?$" }, { "source": "/blog/:slug", "destination": "/writing/:slug", "statusCode": 308, "regex": "^(?!/_next)/blog(?:/([^/]+?))(?:/)?$" }, { "source": "/blog/posts/:slug", "destination": "/writing/:slug", "statusCode": 308, "regex": "^(?!/_next)/blog/posts(?:/([^/]+?))(?:/)?$" }, { "source": "/articles/:slug", "destination": "/writing/:slug", "statusCode": 308, "regex": "^(?!/_next)/articles(?:/([^/]+?))(?:/)?$" }, { "source": "/get-in-touch", "destination": "/contact", "statusCode": 308, "regex": "^(?!/_next)/get-in-touch(?:/)?$" }, { "source": "/hire-me", "destination": "/contact", "statusCode": 308, "regex": "^(?!/_next)/hire-me(?:/)?$" }, { "source": "/cv", "destination": "/resume", "statusCode": 308, "regex": "^(?!/_next)/cv(?:/)?$" }, { "source": "/resume.pdf", "destination": "/Isaac_Vazquez_Resume.pdf", "statusCode": 308, "regex": "^(?!/_next)/resume\\.pdf(?:/)?$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/accessibility", "regex": "^/accessibility(?:/)?$", "routeKeys": {}, "namedRegex": "^/accessibility(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/api/data-manager", "regex": "^/api/data\\-manager(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/data\\-manager(?:/)?$" }, { "page": "/api/data-metadata", "regex": "^/api/data\\-metadata(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/data\\-metadata(?:/)?$" }, { "page": "/api/fantasy-data", "regex": "^/api/fantasy\\-data(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/fantasy\\-data(?:/)?$" }, { "page": "/api/fantasy-pros-free", "regex": "^/api/fantasy\\-pros\\-free(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/fantasy\\-pros\\-free(?:/)?$" }, { "page": "/api/fantasy-pros-session", "regex": "^/api/fantasy\\-pros\\-session(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/fantasy\\-pros\\-session(?:/)?$" }, { "page": "/api/investments/index", "regex": "^/api/investments/index(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/investments/index(?:/)?$" }, { "page": "/api/investments/quotes", "regex": "^/api/investments/quotes(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/investments/quotes(?:/)?$" }, { "page": "/api/news-pulse", "regex": "^/api/news\\-pulse(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/news\\-pulse(?:/)?$" }, { "page": "/api/rss", "regex": "^/api/rss(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/rss(?:/)?$" }, { "page": "/api/sample-data", "regex": "^/api/sample\\-data(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/sample\\-data(?:/)?$" }, { "page": "/api/scheduled-update", "regex": "^/api/scheduled\\-update(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/scheduled\\-update(?:/)?$" }, { "page": "/api/scrape", "regex": "^/api/scrape(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/scrape(?:/)?$" }, { "page": "/api/search", "regex": "^/api/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/search(?:/)?$" }, { "page": "/api/spacex/launches", "regex": "^/api/spacex/launches(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/spacex/launches(?:/)?$" }, { "page": "/api/spacex/summary", "regex": "^/api/spacex/summary(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/spacex/summary(?:/)?$" }, { "page": "/api/stocks", "regex": "^/api/stocks(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/stocks(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/fantasy-football", "regex": "^/fantasy\\-football(?:/)?$", "routeKeys": {}, "namedRegex": "^/fantasy\\-football(?:/)?$" }, { "page": "/fantasy-football/draft-tracker", "regex": "^/fantasy\\-football/draft\\-tracker(?:/)?$", "routeKeys": {}, "namedRegex": "^/fantasy\\-football/draft\\-tracker(?:/)?$" }, { "page": "/fantasy-football/rb-tiers", "regex": "^/fantasy\\-football/rb\\-tiers(?:/)?$", "routeKeys": {}, "namedRegex": "^/fantasy\\-football/rb\\-tiers(?:/)?$" }, { "page": "/fintech-tools/interchange-iq", "regex": "^/fintech\\-tools/interchange\\-iq(?:/)?$", "routeKeys": {}, "namedRegex": "^/fintech\\-tools/interchange\\-iq(?:/)?$" }, { "page": "/investments", "regex": "^/investments(?:/)?$", "routeKeys": {}, "namedRegex": "^/investments(?:/)?$" }, { "page": "/march-madness-2026", "regex": "^/march\\-madness\\-2026(?:/)?$", "routeKeys": {}, "namedRegex": "^/march\\-madness\\-2026(?:/)?$" }, { "page": "/march-madness-2026/opengraph-image", "regex": "^/march\\-madness\\-2026/opengraph\\-image(?:/)?$", "routeKeys": {}, "namedRegex": "^/march\\-madness\\-2026/opengraph\\-image(?:/)?$" }, { "page": "/news-pulse", "regex": "^/news\\-pulse(?:/)?$", "routeKeys": {}, "namedRegex": "^/news\\-pulse(?:/)?$" }, { "page": "/opengraph-image", "regex": "^/opengraph\\-image(?:/)?$", "routeKeys": {}, "namedRegex": "^/opengraph\\-image(?:/)?$" }, { "page": "/portfolio", "regex": "^/portfolio(?:/)?$", "routeKeys": {}, "namedRegex": "^/portfolio(?:/)?$" }, { "page": "/resume", "regex": "^/resume(?:/)?$", "routeKeys": {}, "namedRegex": "^/resume(?:/)?$" }, { "page": "/search", "regex": "^/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/search(?:/)?$" }, { "page": "/spacex-mission-control", "regex": "^/spacex\\-mission\\-control(?:/)?$", "routeKeys": {}, "namedRegex": "^/spacex\\-mission\\-control(?:/)?$" }, { "page": "/writing", "regex": "^/writing(?:/)?$", "routeKeys": {}, "namedRegex": "^/writing(?:/)?$" }], "dynamic": [{ "page": "/api/auth/[...nextauth]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPnextauth": "nxtPnextauth" }, "namedRegex": "^/api/auth/(?<nxtPnextauth>.+?)(?:/)?$" }, { "page": "/api/investments/data/[symbol]", "regex": "^/api/investments/data/([^/]+?)(?:/)?$", "routeKeys": { "nxtPsymbol": "nxtPsymbol" }, "namedRegex": "^/api/investments/data/(?<nxtPsymbol>[^/]+?)(?:/)?$" }, { "page": "/api/spacex/launches/[id]", "regex": "^/api/spacex/launches/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/spacex/launches/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/fantasy-football/tiers/[position]", "regex": "^/fantasy\\-football/tiers/([^/]+?)(?:/)?$", "routeKeys": { "nxtPposition": "nxtPposition" }, "namedRegex": "^/fantasy\\-football/tiers/(?<nxtPposition>[^/]+?)(?:/)?$" }, { "page": "/portfolio/[slug]", "regex": "^/portfolio/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/portfolio/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/writing/[slug]", "regex": "^/writing/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/writing/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/about": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/about", "dataRoute": "/about.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/accessibility": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/accessibility", "dataRoute": "/accessibility.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/contact": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/contact", "dataRoute": "/contact.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/fantasy-football/draft-tracker": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/fantasy-football/draft-tracker", "dataRoute": "/fantasy-football/draft-tracker.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/fantasy-football/rb-tiers": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/fantasy-football/rb-tiers", "dataRoute": "/fantasy-football/rb-tiers.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/fintech-tools/interchange-iq": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/fintech-tools/interchange-iq", "dataRoute": "/fintech-tools/interchange-iq.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/march-madness-2026/opengraph-image": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/png", "x-next-cache-tags": "_N_T_/layout,_N_T_/march-madness-2026/layout,_N_T_/march-madness-2026/opengraph-image/layout,_N_T_/march-madness-2026/opengraph-image/route,_N_T_/march-madness-2026/opengraph-image" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/march-madness-2026/opengraph-image", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/opengraph-image": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/png", "x-next-cache-tags": "_N_T_/layout,_N_T_/opengraph-image/layout,_N_T_/opengraph-image/route,_N_T_/opengraph-image" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/opengraph-image", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/civic-engagement-platform": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/civic-engagement-platform.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/data-analytics-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/data-analytics-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/fantasy-football-analytics": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/fantasy-football-analytics.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/interchange-iq": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/interchange-iq.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/investment-analytics-platform": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/investment-analytics-platform.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/march-madness-2026": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/march-madness-2026.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/news-pulse-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/news-pulse-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/performance-monitoring": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/performance-monitoring.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/spacex-mission-control": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/spacex-mission-control.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio/test-automation-suite": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio/[slug]", "dataRoute": "/portfolio/test-automation-suite.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/portfolio": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/portfolio", "dataRoute": "/portfolio.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/resume": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/resume", "dataRoute": "/resume.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/2025-fantasy-football-draft-strategy": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/2025-fantasy-football-draft-strategy.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/2026-march-madness-bracket-analysis": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/2026-march-madness-bracket-analysis.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/ai-in-software-testing-future-of-qa": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/ai-in-software-testing-future-of-qa.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/building-a-fantasy-football-rankings-platform": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/building-a-fantasy-football-rankings-platform.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/building-ai-powered-analytics-fantasy-football-to-enterprise": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/building-ai-powered-analytics-fantasy-football-to-enterprise.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/building-an-investment-research-platform": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/building-an-investment-research-platform.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/building-news-pulse-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/building-news-pulse-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/building-reliable-software-systems": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/building-reliable-software-systems.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/building-spacex-mission-control": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/building-spacex-mission-control.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/complete-guide-qa-engineering": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/complete-guide-qa-engineering.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/cybersecurity-in-age-of-ai-software-engineer-perspective": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/cybersecurity-in-age-of-ai-software-engineer-perspective.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/evolution-software-architecture-monoliths-ai-native-systems": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/evolution-software-architecture-monoliths-ai-native-systems.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/fantasy-football-beginners-complete-guide": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/fantasy-football-beginners-complete-guide.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/getting-started-with-automated-testing": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/getting-started-with-automated-testing.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/interchange-iq-payment-fee-analyzer": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/interchange-iq-payment-fee-analyzer.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/low-code-no-code-vs-traditional-development-when-to-choose": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/low-code-no-code-vs-traditional-development-when-to-choose.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/mastering-fantasy-football-analytics": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/mastering-fantasy-football-analytics.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/qa-engineer-guide-testing-ai-systems": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/qa-engineer-guide-testing-ai-systems.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/qa-engineering-silicon-valley-uc-berkeley-mba-perspective": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/qa-engineering-silicon-valley-uc-berkeley-mba-perspective.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/rb-vs-wr-draft-strategy-modeling-positional-value": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/rb-vs-wr-draft-strategy-modeling-positional-value.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/understanding-fantasy-football-analytics": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/understanding-fantasy-football-analytics.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/waiver-wire-mastery-hidden-gems": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing/[slug]", "dataRoute": "/writing/waiver-wire-mastery-hidden-gems.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/writing", "dataRoute": "/writing.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": { "/portfolio/[slug]": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "routeRegex": "^/portfolio/([^/]+?)(?:/)?$", "dataRoute": "/portfolio/[slug].rsc", "fallback": null, "fallbackRouteParams": [], "dataRouteRegex": "^/portfolio/([^/]+?)\\.rsc$", "prefetchDataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/writing/[slug]": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "routeRegex": "^/writing/([^/]+?)(?:/)?$", "dataRoute": "/writing/[slug].rsc", "fallback": null, "fallbackRouteParams": [], "dataRouteRegex": "^/writing/([^/]+?)\\.rsc$", "prefetchDataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "notFoundRoutes": [], "preview": { "previewModeId": "29002111c3f2bb46d05e1b716c4433d7", "previewModeSigningKey": "cc413b448ad7c6c24a01d46dc3d517a3a44f0a537e6c9bfc371c6876121c698d", "previewModeEncryptionKey": "b8a0520c81ee4147c9a92e82dd601446a1a5cc25e2b9958d21de62e2718ff90d" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|api\\/).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|api/).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ooiPNaC4xMZGBCIMNF3cX", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "yWrfwe0EAvrU2jvpI0ZDr1gL/gOQKKTIgstyQPQWWwM=", "__NEXT_PREVIEW_MODE_ID": "29002111c3f2bb46d05e1b716c4433d7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "cc413b448ad7c6c24a01d46dc3d517a3a44f0a537e6c9bfc371c6876121c698d", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "b8a0520c81ee4147c9a92e82dd601446a1a5cc25e2b9958d21de62e2718ff90d" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/_global-error/page": "/_global-error", "/api/fantasy-pros-free/route": "/api/fantasy-pros-free", "/api/data-metadata/route": "/api/data-metadata", "/api/fantasy-data/route": "/api/fantasy-data", "/api/data-manager/route": "/api/data-manager", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/fantasy-pros-session/route": "/api/fantasy-pros-session", "/api/investments/data/[symbol]/route": "/api/investments/data/[symbol]", "/api/investments/index/route": "/api/investments/index", "/api/news-pulse/route": "/api/news-pulse", "/api/rss/route": "/api/rss", "/api/sample-data/route": "/api/sample-data", "/api/scheduled-update/route": "/api/scheduled-update", "/api/scrape/route": "/api/scrape", "/api/spacex/launches/[id]/route": "/api/spacex/launches/[id]", "/api/search/route": "/api/search", "/api/spacex/launches/route": "/api/spacex/launches", "/api/spacex/summary/route": "/api/spacex/summary", "/api/stocks/route": "/api/stocks", "/march-madness-2026/opengraph-image/route": "/march-madness-2026/opengraph-image", "/opengraph-image/route": "/opengraph-image", "/api/investments/quotes/route": "/api/investments/quotes", "/page": "/", "/about/page": "/about", "/accessibility/page": "/accessibility", "/contact/page": "/contact", "/fintech-tools/interchange-iq/page": "/fintech-tools/interchange-iq", "/investments/page": "/investments", "/news-pulse/page": "/news-pulse", "/march-madness-2026/page": "/march-madness-2026", "/resume/page": "/resume", "/portfolio/page": "/portfolio", "/search/page": "/search", "/spacex-mission-control/page": "/spacex-mission-control", "/writing/[slug]/page": "/writing/[slug]", "/portfolio/[slug]/page": "/portfolio/[slug]", "/writing/page": "/writing", "/fantasy-football/rb-tiers/page": "/fantasy-football/rb-tiers", "/fantasy-football/tiers/[position]/page": "/fantasy-football/tiers/[position]", "/fantasy-football/draft-tracker/page": "/fantasy-football/draft-tracker", "/fantasy-football/page": "/fantasy-football", "/admin/page": "/admin" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/march-madness-2026/opengraph-image": {}, "/opengraph-image": {} } };
