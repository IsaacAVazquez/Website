...
export const siteConfig = {
  ...
  keywords: [
    ...
    "Austin Product Manager",
    "Austin Technical Product Manager",
    "Austin Tech Professional",
    "Austin Fantasy Football Analytics",
    "Texas Product Manager",
    "Austin Product Strategy",
    "Austin Product Development",
    "Austin MBA Student",
