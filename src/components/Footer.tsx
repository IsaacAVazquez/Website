  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="rounded-2xl p-8 md:p-12 text-center bg-[var(--neutral-900)] dark:bg-[var(--neutral-800)] border border-[var(--neutral-700)] dark:border-[var(--neutral-600)]">
