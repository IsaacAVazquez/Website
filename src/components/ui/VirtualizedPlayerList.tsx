...
const VirtualizedPlayerListComponent: React.FC<VirtualizedPlayerListProps> = ({
  players,
  onPlayerClick,
  onPlayerDraft,
  itemHeight = 80,
...
export const VirtualizedPlayerList = React.memo(VirtualizedPlayerListComponent, (prevProps, nextProps) => {
  ...
  return (
    ...
    prevProps.onPlayerDraft === nextProps.onPlayerDraft
  );
});
