...
export function MissionVehiclePhoto({
  ...
  return (
    <MissionImageFrame
      ...
      className={`flex items-center justify-center rounded-[28px] border border-[color-mix(in_srgb,var(--home-haze)_18%,var(--home-rule))] bg-[linear-gradient(160deg,color-mix(in_srgb,var(--home-haze)_10%,var(--home-paper-raised))_0%,var(--home-paper-raised)_72%)] shadow-[var(--shadow-md)] ${className}`}
    >
      <div
        aria-hidden="true"
