> [!IMPORTANT]
> Historical reference only. This file captures an older admin implementation note and is not a current source of truth by itself. Use `AGENT.md`, `README.md`, `API.md`, `ARCHITECTURE.md`, and `docs/README.md` for current documentation.
