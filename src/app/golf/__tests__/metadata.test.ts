...
describe("Golf metadata", () => {
  it("uses the route-specific open graph image", () => {
    ...
    expect(openGraph.images[0].url).toBe("https://isaacvazquez.com/golf/opengraph-image");
    expect(twitter.images[0]).toBe("https://isaacvazquez.com/golf/opengraph-image");
  });
});
