...
export const metadata = generateAIOptimizedMetadata({
  ...
  context: "Case studies following Problem-Process-Result framework, demonstrating product management expertise from a Technical PM with engineering background at UC Berkeley Haas",
  author: {
    name: "Isaac Vazquez",
    title: "Technical Product Manager | UC Berkeley Haas MBA Candidate '27",
    credentials: [
